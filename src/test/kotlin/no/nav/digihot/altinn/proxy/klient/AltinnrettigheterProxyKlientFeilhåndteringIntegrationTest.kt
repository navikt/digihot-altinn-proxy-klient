...
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.FNR_INNLOGGET_BRUKER
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.INVALID_SERVICE_CODE
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.SERVICE_EDITION
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.SYKEFRAVÆR_SERVICE_CODE
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn mottar riktig request`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn returnerer 200 OK og en liste med to AltinnReportee`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn returnerer 400 Bad Request`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn-rettigheter-proxy mottar riktig request med flere parametre`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn-rettigheter-proxy mottar riktig request`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn-rettigheter-proxy returnerer 200 OK og en liste med AltinnReportees`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn-rettigheter-proxy returnerer 500 uhåndtert feil`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn-rettigheter-proxy returnerer 502 Bad Gateway`
import no.nav.digihot.altinn.proxy.klient.AltinnrettigheterProxyKlientIntegrationTestUtils.Companion.`altinn-rettigheter-proxy returnerer en feil av type 'httpStatus' med 'kilde' og 'melding' i response body`
...
import no.nav.digihot.altinn.proxy.klient.model.Subject
